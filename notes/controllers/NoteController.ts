...
export default class NoteController implements AbstractNoteController {
    ...
    public createNote = async (req, res, next) => {
    ...
    deleteNote = async (req, res, next): Promise<void> => {
